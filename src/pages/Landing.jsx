...
class Landing extends PureComponent {
    state = {
        faq: [
            ...
            {
                q: "Can the mental disorders like OCD, drug deaddiction, migraine and depression be successfully treated?",
    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <div className="phone">
                    <a href="tel:+919588310945" aria-label="phone number" target="_blank" id="togglw1" className="phne">
                ...
                <div class="leftImg">
                    <div className="me-2 ms-2" style={{ paddingBottom: "30px" }}>
                        <div class="hero-text text-center container ">
                            <h2 className="white pt-4" > Mental Fitness and Life Improvement</h2>
                            <p className='white'>Of course, a psychiatrist can treat mental illness. However, you can expect more. Whether you are a businessman, sportsperson, an officer, or an adult, woman or concerned about your child.
                                Through knowledge of psychiatry and counselling, you can realize and achieve full potential of your brain.</p>
                            <i class='fa fa-arrow-down pt-3 fw-bold blue' style={{ fontSize: "65px" }}></i>

                            <div className="row pt-3">

                                <div className="col-md-6 col-lg-3 pt-3" data-aos="fade-right"
                                    data-aos-offset="0"
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className='white'>Whether you want reliance or you are just concerned about your well-being.
                                            A psychiatrist is not only to cure a mental disease.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 col-lg-3 pt-3" data-aos="fade-right"
                                    ...
                                    <div className="text-center">
                                        <img src={img5} 
                                            width={"123"}
                                            height={"142"} alt="anxiety" />
                                        <p className='fw-bold white' >Counselling</p>
                                        <p className='white'>
                                            At Dr Vikas Mind Clinic in West Delhi, you will find consultant for coaching and guidance for assessments and sessions.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 col-lg-3 pt-3" data-aos="fade-right"
                                    ...
                                    <div className="text-center">
                                        <img src={img6} 
                                        width={"105"}
                                            height={"150"} alt="dependence" />
                                        <p className='fw-bold white' >Holistic Approach</p>
                                        <p className='white' >We believe in treating our patient holistically. We do everything possible that the person doesn’t need a psychiatrist again for the mental disorder.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 col-lg-3 pt-3" data-aos="fade-right"
                                    ...
                                    <div className="text-center">
                                        <img src={img7}
                                         width={"102"}
                                            height={"150"} alt="schizophrenia" />
                                        <p className='fw-bold white'> Chronic Disorders</p>
                                        <p className='white'>Is your illness related to brain not given timely treatment? Reaching out to best psychiatrist in Delhi should not be a Stigma anymore. </p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-12 col-lg-6  landing-services" data-aos="fade-up-left" >
                                    ...
                                    <div className="d-flex justify-content-center pt-3">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Depression can be due to genetics.
                                                Or it can be due to stress related to work, social life or health issues.
                            ...
                            <div className="row">
                                <div className="col-md-12 col-lg-4 ">
                                    <div className="d-flex justify-content-center pt-3">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Migraine can cause regular headache or there can be severe migraine attacks. In any case, this should never be ignored.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-12 col-lg-4">
                                    <div className="d-flex justify-content-center pt-3">
                                        ...
                                        <div>
                                            <p>
                                                <Link to="/" className="blue fw-bold text-decoration-none">Drugs Deaddiction</Link>
                                            </p>
                                            <p>
                                                Dr Vikas has expertise in drug deaddiction and knows how to treat after effects that
                                                affect the victim socially, physically and mentally.
                                ...
                                <div className="col-md-12 col-lg-4">
                                    <div className="d-flex justify-content-center pt-3">
                                        ...
                                        <div>
                                            <p>
                                                <Link to="/epilepsy-doctor-delhi" className="blue fw-bold  text-decoration-none">Epilepsy Treatment</Link>
                                            </p>
                                            <p>
                                                You should reach out to a good psychiatrist in Delhi. Epilepsy is a serious problem that may not be easily understood by anyone.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="container" >
                            <div className="row">
                                <div className="col-md-6 landing-services1">
                                    <h2 class="blue">Best Psychiatrist in
                                        <span className='green'> Delhi NCR </span></h2>
                                    <p>
                                        Dr Vikas Moun is not an ordinary doctor in West Delhi. He’s the best psychiatrist in Delhi and has a huge list of people who have recovered from severe mental disorders. He understands how to control mental illness through medicine, by mentoring or just by motivation.
                                    </p>
                                    <ul className='pt-2'>
                                        <li><b>MD in Psychiatry</b> from <Link to="https://www.kgmu.org/">King George's Medical College</Link></li>
                                        <li>Over a decade of experience of curing variety of mental disorders</li>
                                        <li>Ex. Senior Resident at “Dept of Psychiatry PGIMS Rohtak”</li>
                                        <li>Worked for Bhatia Global Hospital, Ujala Cygnus Hospital Nangloi and Satyabhama Hospital</li>

                                    </ul>
                                </div>
                                {/* <div className="bg-light" style={{height:"70px"}}></div> */}
                                <div className="col-md-6 mt-4 text-center" >
                                    <img style={{ borderRadius: "22px" }} width={"100%"}
                                        height={"100%"} src={aboutimg} className="img-fluid " alt="Dr Vikas Mind Moun" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className='landingChooseUs' style={{ marginTop: "30px" }}>
                    <div className="me-2 ms-2">
                        <div className="container">
                            <h3 class="blue text-center">Why Doctor Vikas is top  <span className='green'> psychiatrist in Delhi?</span>  </h3>
                            <ChooseUs />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="me-2 ms-2">
                        <div className="row">
                            <div className="col-md-7 m-auto bg-white">
                                ...
                                <p>
                                    The attitude of avoiding session with doctor is not so cool. It can harm your living as well as your family. In order to use your brain effectively, and to improve your self-esteem, professional help is good. Phobias, hallucinations, addiction, any type of disturbance with your thoughts can easily be fixed by a doctor. Let the psychiatrist control the issue and help you with the recovery from your psychiatric and psychological issues. Dr. Vikas Moun is an experienced Psychiatrist in West Delhi. And he can help you with prevention, control and cure of your mental issues.
                                </p>
                                <Link to="/contact" class="btn text-white mt-3 fw-bold shadow-none btncontact2" >
                                    Contact Us
                                </Link>
                            </div>
