    ...
    return (
      <Fragment>
        ...
        <div className="container">
          <div className="row pt-4">
            <div className="col-md-9">
              <h1 style={{ color: "#38a454" }} className="fw-bold">
                {" "}
                You can reach out to us for professional assistance ranging from
                suspicion to advanced cases of
              </h1>
              <p className="fs-5 text-hero-regular">
                Lorem ipsum dolor sit amet, conse ctetur adipes iscing elit, sed
                do eiusmod tempor incidi dunt ut labore et dolore magna aliqua.
                Lorem ipsum dolor sit amet, conse ctetur adipes iscing elit, sed
                do eiusmod tempor incidi dunt ut labore et dolore magna aliqua.
                Lorem ipsum dolor sit amet, conse ctetur adipes iscing elit, sed
                do eiusmod tempor incidi dunt ut labore et dolore magna aliqua.
            ...
            <div className="col-md-3 " style={{ backgroundColor: "#005279" }}>
              ...
              <div className="d-flex justify-content-center pb-4 pt-2">
                ...
                <p className="fs-5 text-white ps-3">
                  Lorem ipsum dolorsitamet,conse
                  <br />
                  <Link
                    to="/blog"
                    className="mt-5 fw-bold text-decoration-none text-white"
                  >
                    {" "}
                    Read More..
                  </Link>
        ...
        <div className="landBlog " style={{ marginTop: "10%" }}>
          <div className="container">
            <div
              class="fw-bold text-white mb-4 mt-4 pt-4 "
              style={{ fontSize: "34px" }}
            >
              Recent Blogs
            </div>
