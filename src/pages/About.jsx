    ...
    return (
      <Fragment>
        <Helmet>
          ...
          <meta
            name="description"
            content="Let us know a Brief about Dr Vikas Moun and Dr Vikas Mind Care Clinic."
          />
        </Helmet>
        <noscript>
          <iframe
        ...
        <div className="me-2 ms-2" style={{ paddingTop: "30px" }}>
          <div className=" container">
            <h2 class="text-center blue">
              We Treat for a Wide Variety of Mental Health Issues at{" "}
              <span className="green">Dr Vikas Mind Clinic</span>
            </h2>
            <p className="text-center">
              In the world of mental health, right and professional guidance
              helps treat and recover patients from years of internal pain. At
              Dr Vikas Mind Clinic, we offer a wide variety of diagnosis and
              treatment for various mental health issues. Our specialty clinic
              is dedicated to providing expert psychiatric care for a wide
              spectrum of mental health conditions, including but not limited to
              anxiety disorders, ADHD, mood disorders, Personality disorders,
              addiction, trauma, epilepsy, depression and neuropsychiatric
              conditions. The clinic caters to individuals residing in and
              around West Delhi. Our clinic is committed to providing new-age
            ...
            <div className="row">
              <div className="col-md-6 text-center">
                <img
                  src={img7}
                  alt="Dr Vikas Moun"
                  className="img-fluid w-50 shadow-sm bg-white rounded"
                />
              </div>
              <div className="col-md-6">
                <h2 className="blue">
                  ...
                  <br />
                  Your First Step for a{" "}
                  <span className="green"> Better Life </span>
                </h2>
                <p>
                  Dr. Vikas Moun is an esteemed psychiatrist with an MD in
                  Psychiatry from the prestigious King George's Medical College
                  Lucknow. With more than a decade of experience and expertise,
                  he also has worked as a Consultant Psychiatrist with some of
                  the most prestigious hospitals in Delhi, such as Bhatia Global
                  Hospital, Ujala Cygnus Hospital Nangloi and Satyabhama
                  Hospital Nangloi. Well aware of the stigma that surrounds
                  mental health disorders, he today has a clinic where anyone
                  could readily find help in the most comfortable and discreet
                  way. His empathetic approach, extensive knowledge, and
                  personalised treatment plans has treated over thousands to
                ...
                <div className="d-flex flex-wrap justify-content-around mt-4">
                  <Link
                    to="#"
                    class="btn text-white fw-bold m-auto shadow-none btncontact2"
                  >
                    See Offer
                  </Link>
                  ...
                  <Link
                    to="#"
                    class="btn rounded-0 m-auto fw-bold btn-hover shadow-none"
                    style={{ color: "#00537b", border: "3px solid #00537b" }}
                  >
                    Contact Us
                  </Link>
                </div>
