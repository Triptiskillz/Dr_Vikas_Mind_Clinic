    ...
    return (
      <Fragment>
        <Helmet>
          ...
          <meta
            name="description"
            content="Contact Dr Vikas Mind Clinic and book an appointment to meet Dr Vikas Moun in person."
          />
        </Helmet>
        <noscript>
          <iframe
        ...
        <div className="Service-hero d-flex justify-content-center mb-4">
          <div className="fs-1 fw-bold text-center text-white mt-4 pt-4 mb-4 pb-4 container">
            ...
            <p className="white text-center">
              {" "}
              Book your appointment with Dr Vikas Mind Clinic for a better
              version of yourself. Let us know your concern and we’re happy to
              help.
            </p>
          </div>
        </div>
        ...
        <div className="hadingspace container">
          <div className="row">
            <div className="col-md-6 m-auto text-center">
              ...
              <a
                href="https://goo.gl/maps/VC8nsH2XZ4s9vvNJ6"
                aria-label="adderss"
                target="_blank"
              ...
              <a
                href="mailto:hello@drvikasmindclinic.com"
                aria-label="email"
                target="_blank"
                className="text-decoration-none"
              >
        ...
        <div className="hadingspace container">
          <div className="row">
            <div className="col-md-6 m-auto text-center">
              ...
              <a
                href="https://goo.gl/maps/rzgWz6MNNWvQtgu58"
                aria-label="adderss"
                target="_blank"
                className="text-decoration-none"
              >
                <p>
                  {" "}
                  First Floor, Delhi - Rohtak Rd, opposite Metro Pillar Number
                  829, Bahadurgarh, Haryana, 124507
                </p>
              </a>
            ...
            <div className="col-md-6 m-auto text-center">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13999.8932656067!2d76.9369408!3d28.6904448!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d057da8b479c5%3A0x41c3c532c2bacec3!2sDr%20Vikas%20Mind%20Care%20Clinic!5e0!3m2!1sen!2sin!4v1691764352533!5m2!1sen!2sin"
                width="100%"
                height="600px"
                // style="border:0;"
                allowfullscreen=""
          ...
          <div className="me-2 ms-2">
            <div class="about">
              <div class="inner-section rounded">
                <h3 class=" blue w-100 text-center">Contact Us</h3>
                <ContactFrom />
              </div>
            </div>
          </div>
