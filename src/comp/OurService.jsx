        ...
        return (
            <>
                <div className="row">
                    {data.map((d,index) => (
                        <>
                            <div className="col-md-6 col-lg-3 mt-4 mb-4" data-aos="fade-zoom-in"
                                ...
                                <div className="OurServicecontainer p-2">
                                    ...
                                    <Link to={`/${d.url}`} className="text-decoration-none text-white text-hover">
                                    <h3 className="fw-bold text-center mt-2 mb-2 blue">{d.title} </h3>
                                    </Link>
                                </div>
