                        ...
                        <>
                            <div className="col-md-4"   >
                                <div class="box-area" style={{padding:"0px"}}>
                                    <div class="pb-4">
                                        <img src={d.img} alt=""  style={{height:"13rem",width:'100%'}} />
                                    </div>
                                    <b className="fs-5 fw-bold mt-4 pt-4 ps-4" style={{ color: "#00537b" }}>{d.title}</b>
            
                                    <p className="fs-6 ps-4 pe-4 pb-4 pt-2">{d.des}
                                    <br/>
                                      <Link to="/blog" className="mt-4 fw-bold text-decoration-none text-dark"> Read More..</Link>
                                    </p>
