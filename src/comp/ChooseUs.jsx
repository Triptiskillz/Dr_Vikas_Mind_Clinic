...
class ChooseUs extends Component {
    state = {
        data: [
            ...
            { id: 3, img: img16, text: "Experience of curing chronic cases successfullys" },
            { id: 4, img: img17, text: "Patient gets direct contact number of the doctor" },
            { id: 5, img: img18, text: "Skillful diagnosis. No unnecessary testing like MRI, CT scan" },
            { id: 6, img: img19, text: "Personal connection with the patient for better understanding" },
        ]
    }
    render() {
        let { data } = this.state
