                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            <h4 className="mb-1 mt-4 blue">
                                ...
                                <p> <i class="fa fa-phone-square fs-3 me-3" style={{ color: "#38a454" }} aria-hidden="true"></i> +91-9588310945</p>
                                <p> <i class="fa fa-envelope fs-3 me-3 mt-3" style={{ color: "#38a454" }} aria-hidden="true"></i> hello@drvikasmindclinic.com</p>
                                {/* <spna> <i class="fa fa-address-card fs-2 me-3 mt-3" style={{ color: "#38a454" }} aria-hidden="true"></i>First Floor, Delhi - Rohtak Rd, opposite Metro Pillar Number 829, Bahadurgarh, Haryana 124507</spna><br/> */}
